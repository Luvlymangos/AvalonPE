...
namespace PersistentEmpiresSave.Database.Repositories
{
    public class DBPlayerRepository
    {
        public static void Initialize()
        {
            ...
            SaveSystemBehavior.OnCPURegister += OnCPURegister;
        }
        ...
        private static void OnCPURegister(NetworkCommunicator player, string id)
        {
            bool created = false;
            DBPlayer dbplayer = GetOrCreatePlayer(player, out created);

            string updateQuery = "UPDATE Players SET CPUID = @CPUId WHERE PlayerId = @PlayerId";
            DBConnection.Connection.Execute(updateQuery, new
            {
                CPUId = id,
                PlayerId = dbplayer.PlayerId
        ...
        private static DBPlayer CreateDBPlayer(NetworkCommunicator peer)
        {
            ...
            DBPlayer dbPlayer = new DBPlayer
            {
                ...
                Weaving = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Weaving").Value,
                WeaponSmithing = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("WeaponSmithing").Value,
                ArmourSmithing = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("ArmourSmithing").Value,
                BlackSmithing = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("BlackSmithing").Value,
                Carpentry = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Carpentry").Value,
                Cooking = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Cooking").Value,
                Farming = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Farming").Value,
                Mining = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Mining").Value,
                Fletching = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Fletching").Value,
                Animals = persistentEmpireRepresentative == null ? 0 : persistentEmpireRepresentative.GetSkill("Animals").Value
            };
        ...
        public static DBPlayer SavePlayer(NetworkCommunicator peer)
        {
            ...
            string updateQuery = "UPDATE Players SET Name = @Name, Hunger = @Hunger, Health = @Health, Money = @Money, Horse = @Horse, HorseHarness = @HorseHarness, Equipment_0 = @Equipment_0, Equipment_1 = @Equipment_1, Equipment_2 = @Equipment_2, Equipment_3 = @Equipment_3, Armor_Head = @Armor_Head, Armor_Body = @Armor_Body, Armor_Leg = @Armor_Leg, Armor_Gloves = @Armor_Gloves, Armor_Cape = @Armor_Cape, PosX = @PosX, PosY = @PosY, PosZ = @PosZ, FactionIndex = @FactionIndex, Class = @Class, Ammo_0 = @Ammo_0, Ammo_1 = @Ammo_1, Ammo_2 = @Ammo_2, Ammo_3 = @Ammo_3, Weaving = @Weaving, ArmourSmithing = @ArmourSmithing, WeaponSmithing = @WeaponSmithing, BlackSmithing = @BlackSmithing, Carpentry = @Carpentry, Cooking = @Cooking, Farming = @Farming, Mining = @Mining, Fletching = @Fletching, Animals = @Animals WHERE PlayerId = @PlayerId";
        ...
        public static DBPlayer CreatePlayer(NetworkCommunicator peer)
        {
            ...
            string insertQuery = "INSERT INTO Players (PlayerId, Name, Hunger, Health, Money, Horse, HorseHarness, Equipment_0, Equipment_1, Equipment_2, Equipment_3, Armor_Head, Armor_Body, Armor_Leg, Armor_Gloves, Armor_Cape, PosX, PosY, PosZ, FactionIndex, Class, Ammo_0, Ammo_1, Ammo_2, Ammo_3, Weaving, WeaponSmithing, ArmourSmithing, BlackSmithing, Carpentry, Cooking, Farming, Mining, Fletching, Animals) VALUES (@PlayerId, @Name, @Hunger, @Health, @Money, @Horse, @HorseHarness, @Equipment_0, @Equipment_1, @Equipment_2, @Equipment_3, @Armor_Head, @Armor_Body, @Armor_Leg, @Armor_Gloves, @Armor_Cape, @PosX, @PosY, @PosZ, @FactionIndex, @Class, @Ammo_0, @Ammo_1, @Ammo_2, @Ammo_3, @Weaving, @ArmourSmithing, @WeaponSmithing, @BlackSmithing, @Carpentry, @Cooking, @Farming, @Mining, @Fletching, @Animals)";
            DBPlayer player = CreateDBPlayer(peer);
            if (player.FactionIndex == -1) player.FactionIndex = 0;
