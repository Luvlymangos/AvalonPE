        ...
        public override void OnUse(Agent userAgent)
        {
            if (GameNetwork.IsServer)
            {
                ...
                if (this.HouseBed)
                {
                    ...
                    {
                        InformationComponent.Instance.SendMessage("You are not allowed to use this bed", new Color(1f, 0, 0).ToUnsignedInteger(), userAgent.MissionPeer.GetNetworkPeer());
                        return;
                    }
                }
