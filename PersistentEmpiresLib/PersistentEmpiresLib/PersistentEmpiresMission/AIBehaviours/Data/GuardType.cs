...
namespace Data
{
    public class GuardTypeClass
    {
        ...
        public GuardTypeClass(int id, string guardType, string guardClass, List<int> lordSoundEvents, List<int> friendSoundEvents, List<int> neutralSoundEvents)
        {
            GuardID = id;
            GuardType = guardType;
