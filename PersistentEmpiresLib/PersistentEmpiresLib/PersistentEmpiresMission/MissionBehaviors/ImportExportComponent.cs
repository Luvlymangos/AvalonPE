...
namespace PersistentEmpiresLib.PersistentEmpiresMission.MissionBehaviors
{
    public class ImportExportComponent : MissionNetwork
    {
        ...
        private bool HandleRequestImportItem(NetworkCommunicator player, RequestImportItem message)
        {
            ...
            if (good.ImportPrice == 0)
            {
                List<int> updatedSlots2 = persistentEmpireRepresentative.GetInventory().AddCountedItemSynced(message.Item, 1, ItemHelper.GetMaximumAmmo(message.Item));
            ...
            Debug.Print(good.ImportPrice.ToString());
