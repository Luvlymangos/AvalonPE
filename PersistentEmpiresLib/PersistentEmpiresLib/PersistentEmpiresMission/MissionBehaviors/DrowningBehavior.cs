    ...
    public class DrowningBehavior : MissionLogic
    {
        ...
        public override void AfterStart()
        {
            ...
            if (upperLimit == null || lowerLimit == null)
            {
                ...
                Debug.Print("DrowningBehavior: Upper or lower limit not found", 0, Debug.DebugColor.Red);
                return;
            }
        ...
        public override void OnMissionTick(float dt)
        {
            if((this.LastCheckedAt + this.Duration < DateTimeOffset.UtcNow.ToUnixTimeSeconds()) && this.IsSetProperly)
            {
                ...
                {
                    if(agent.IsActive() && agent.Position.Z < UpperLimit && agent.Position.Z > LowerLimit && agent.HealthLimit < 500)
                    {
