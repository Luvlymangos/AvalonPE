...
namespace PersistentEmpiresLib.PersistentEmpiresMission.MissionBehaviors
{
    public class PersistentEmpireClientBehavior : MissionMultiplayerGameModeBaseClient
    {
        ...
        private HouseBehviour _housebehabior;
        ...
        private void OnMyClientSynchronized()
        {
            ...
            this._housebehabior = base.Mission.GetMissionBehavior<HouseBehviour>();
        ...
        protected override void AddRemoveMessageHandlers(GameNetwork.NetworkMessageHandlerRegistererContainer registerer)
        {
            ...
            else
            {
                ...
                registerer.Register<MyCPUId>(this.HandleClientMyCPUId);
            }
        }
        ...
        private void HandleServerCraftingStats(SyncCraftingStats message)
        {
            if (this._myRepresentative != null)
            {
                ...
                if (skill.Key != null)
                {
                    this._myRepresentative.LoadedSkills[message.Skill] = message.Amount;
                }
                else
                {
                    this._myRepresentative.LoadedSkills.Add(message.Skill, message.Amount);
                }
            }
        }
        ...
        private bool HandleClientMyCPUId(NetworkCommunicator player, MyCPUId message)
        {
            SaveSystemBehavior.HandleCPURegister(player, message.Id);
            return true;
        }
